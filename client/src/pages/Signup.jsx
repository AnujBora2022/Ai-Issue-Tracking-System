...
const styles = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .login-link a:hover { color: #c7b4ff; }
`;
    ...
    <>
      ...
      <div className="signup-root">
        <div className="signup-card">
          ...
          <h1 className="signup-title">Create your<br />account</h1>
          <p className="signup-subtitle">Join Projectify and start managing your projects today</p>
